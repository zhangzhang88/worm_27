...
const lessonDescriptions = [
  "1 - Spend the Time 第一遍",  
  "1 - Spend the Time 第二遍",  
  "1 - Spend the Time 第三遍", 
  "2 - Do What You Like to Do 第一遍",
  "2 - Do What You Like to Do 第二遍",
  "2 - Do What You Like to Do 第三遍",
  "3 - Learn to Notice 第一遍",
  "3 - Learn to Notice 第二遍",
  "3 - Learn to Notice 第三遍",
  "4 - Words Over Grammar 第一遍",
  "4 - Words Over Grammar 第二遍",
  "4 - Words Over Grammar 第三遍",
  "5 - Be Patient 第一遍",
  "5 - Be Patient 第二遍",
  "5 - Be Patient 第三遍",
  "6 - Get the Tools 第一遍",
  "6 - Get the Tools 第二遍",
  "6 - Get the Tools 第三遍",
  "7 - Become an Independent Language Learner 第一遍",
  "7 - Become an Independent Language Learner 第二遍",
  "7 - Become an Independent Language Learner 第三遍",

   
];

const visibleLessonsCount = 21;
