...
const lessonDescriptions = [
  "1 - Be independent 要独立 ", 
  "2 - Commitment 承诺",
  "3 - Think super-long-term 超长期思维",
  "4 - Intertwine with the world 与世界融合",
  "5 - Master something 掌握一门技能。",
  "6 - Chase the future 追逐未来",
  "7 - Value only what has endured 只珍惜经得起时间考验的事物",
  "8 - Learn,Prepare for the worst 学习和做好最坏打算",
  "9 - Get rich 致富",
  "10 - Create 创造",
  "11 - Don’t die 不要死",
  "12 - Make a million mistakes 犯无数个错误",
  "13 - Make change 做出改变",
  "14 - Balance everything 平衡一切",
